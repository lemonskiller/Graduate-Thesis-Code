...
with_without=['with','without']#,'without']
...
for with_withouti in with_without:
    ...
    for i in range(total_repeat):
        ...
        if with_withouti=='without':
            model = XGBClassifier(n_estimators=10,random_state=2020) #with 9;without 
        else:
            model = XGBClassifier(n_estimators=9,random_state=2020) #with 9;without 
