...
def construct_feed_dict(features, support, weight_support, labels, labels_mask, placeholders):
    ...
    feed_dict.update({placeholders['weight_support'][i]: weight_support[i] for i in range(len(weight_support))})
    return feed_dict
